...
case "catalogo":
    ...
    die();
    case "catalogo2":
    include_once "controllers/catalogo2.control.php";
    die();
case "login":
...
case "logout":
    ...
    die();
case "singoup":
    include_once "controllers/singoup.control.php";
    die();
case "carritoform":
    include_once "controllers/carritoform.control.php";
    die();
case "carrito":
        include_once "controllers/carrito.control.php";
        die();
case "carritoform1":
        include_once "controllers/carritoform1.control.php";
        die();
case "contacto":
