...
function run()
{
   ...
   /* if ($_SERVER["REQUEST_METHOD"] === "GET") {
    ...
    if(isset($_POST["btnSend"])){
        ...
        validarLogin( $viewData["txtEmail"],  $viewData["txtPswd"]);
...
function validarLogin($loginEmail, $loginPswd)
        {
            ...
            if (count($usuario)>0) {
                ...
                if ($usuario["userpswd"] == $loginPswd) {
                    ...
                    $errors[] = "E002 : No se pudieron contra la contra validar las credenciales ingresadas."; //Contraseña Incorrecta
                }
            } else {
                $errors[] = "E001: No se pudieron user email validar las credenciales ingresadas."; //No existe el usuario
            }
            return $errors;
        }
